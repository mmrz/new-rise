jQuery(document).ready(function ($) {
    var formModal = $('.login-user-modal')
        ...
        , formSignup = formModal.find('#login-signup')
    ...
    //open sign-up form
    mainNav.on('click', '.login-signup', signup_selected);
    //open login-form form
    mainNav.on('click', '.login-signin', login_selected);
    //close modal
    formModal.on('click', function (event) {
        if ($(event.target).is(formModal) || $(event.target).is('.login-close-form')) {
